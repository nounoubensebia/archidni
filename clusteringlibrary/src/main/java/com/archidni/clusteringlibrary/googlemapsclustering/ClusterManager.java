...
import static com.archidni.clusteringlibrary.googlemapsclustering.Preconditions.checkArgument;
...
public class ClusterManager<T extends ClusterItem> implements GoogleMap.OnCameraIdleListener {
    ...
    public interface Callbacks<T extends ClusterItem> {
         ...
         */
        boolean onClusterClick(@NonNull Cluster<T> cluster,Marker marker);
         ...
         * to move to the marker and an info window to appear.
         */
        boolean onClusterItemClick(@NonNull T clusterItem, Marker marker);
    }
